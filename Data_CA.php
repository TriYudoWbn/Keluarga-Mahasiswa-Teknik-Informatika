				...
				<div class="header-content">
					...
					<nav class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item"><a href="Data_Lulus.php">Tampil Data Lulus</a></li>
						</ul>
					</nav>
					...
					<form id="Login">
						...
						<table class="table" border="1">
							...
							while ($row = mysqli_fetch_assoc($hasil)) {
								...
								echo "<td>";
								echo "<a href='edit.php?nim=" . $row['nim'] . " ' class='btn btn-primary' role='button'>EDIT</a>";
								echo "   ";
								echo "<a href='hapus.php?nim=" . $row['nim'] . " ' class='btn btn-primary' role='button'>HAPUS</a>";
								echo "</td>";
								echo "</tr>";
							}
							?>
